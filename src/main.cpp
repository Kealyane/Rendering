...
int main()
{
    ...
    .vertex_buffers = {{
        ...
        .data   = {
            ...
            +0.5f, -0.5f, 30.f, 0.f, // Position2D du 2ème sommet - 1
            +0.5f, +0.5f, 30.f, 30.f, // Position2D du 3ème sommet - 2
            -0.5f, +0.5f, 0.f, 30.f  // Position2D du 4ème sommet - 3
        },
    }},
    .index_buffer   = {
